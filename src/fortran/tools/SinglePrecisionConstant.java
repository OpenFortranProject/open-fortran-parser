...
public class SinglePrecisionConstant extends FortranParserActionNull {
   ...
   SinglePrecisionConstant(String[] args, IFortranParser parser, String filename) {
   ...
   public void real_literal_constant(Token digits, Token fractionExp, Token kindParam) {
      if (fractionExp != null) {
         ...
         System.out.println(", at line=" + fractionExp.getLine() +
                            " col=" + fractionExp.getCharPositionInLine());
      }
   }

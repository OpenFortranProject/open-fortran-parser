...
public class ToC {
   ...
   public static void generateJavaJNIClass(String jniPackage,
      ...
      try {
         ...
         javaFile.write("import fortran.ofp.parser.java.IFortranParserAction;\n");
         ...
         javaFile.write("\tpublic " + className  
                        + "(String[] args, IFortranParser parser, "
                        + "String fileName)"
                        + " {\n" + "\t\tsuper();\n" + "\t}\n");

         for (int i = 0; i < methods.length; i++) {
            // Print out the method mangled name.
            javaFile.write("\tnative public void " + methods[i].getName() + "(");
